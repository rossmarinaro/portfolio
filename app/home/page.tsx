...
export default function Home()
{
    return ( 
        ...
        <section className="component">
            ...
            <div className="p-5 content-container col-2-2 container heading-style rounded-xl" >  
                ...
                <h1 className="digitizer">ABOUT</h1>	

                <p> Ross is a multi-media producer specializing in digital asset creation, illustration, 2d animation,
                ...
                <h1 className="digitizer">SERVICES</h1>	

                <p> My name is Ross, and I am here to elaborate. Feel free to explore the various nuances of this site, there is
